<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddMember.aspx.cs" Inherits="Sample02.AddMember" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div class="jumbotron">
        <label class="h3">新增會員</label>
        <hr />
        <!-- 會員資料 -->
        <div class="form-group">
            <label>帳號</label>
            <input id="txt_account" type="text" class="form-control" runat="server" value="" />
        ...
        <!-- btn click -->
        <asp:Button ID="btn_add" runat="server" Text="新增" CssClass="btn btn-primary" OnClick="addMember" />
